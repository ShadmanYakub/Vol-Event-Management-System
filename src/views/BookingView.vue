...
const superheroes = computed(() => {
  if (booking.value.team == 'Avengers') {
    ...
    booking.value.superhero = 'Superman'
    return [
      'Superman',
      'Batman',
      'Wonder Woman',
    ...
    >
      ...
      <div class="row mb-3">
        ...
        <select
          class="form-select"
          aria-label="Default select example"
          v-model="booking.superhero"
          v-bind:disabled="!booking.team"
        >
          <option v-for="superhero in superheroes" :value="superhero">
            {{ superhero }}
          </option>
        </select>
      </div>
